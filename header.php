...
<head>
    ...
    <meta name="keywords" content="codefactory spring boot api,spring boot rest api">
    <meta name="description" content="CodeFactory - A tool is for creating Spring Boot APIs">
    <title><?=$title?></title>
...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark fixed-top" 
    ...
    font-size: 30px;">
              ...
              <span >
              <span style="color:#007ACC;">Code</span>Factory
              </span>
